                ...
                <div className="col-md-2 text-center">
                    ...
                    <div className="col-md-8 d-flex align-content-center">
                        ...
                        <div className="pos-nav d-flex align-content-center p-2 py-3">
                            <p className="m-0" style={{ fontFamily: 'sans-serif' }}>Home</p><span style={{ fontFamily: 'sans-serif' }}>/User Management</span>
                        </div>
                    </div>
                    <div className="col-md-2 d-flex align-content-center justify-content-center">
                        ...
                        <div className="icon-nav-log p-2 py-3">
                                        ...
                                        <div className="col-md-12 p-0">
                                            <table className="w-100 table-body">
                                                <tr className="table-header">
                                                    <td className="p-3 px-4"><span className="float-start">OrderID</span></td>
                                                    <td className="p-3 px-4 "><span className="float-start">Customer</span></td>
                                                    <td className="p-3 px-4 "><span className="float-start">Date</span></td>
                                                    <td className="p-3 px-4 "><span className="float-start">Location</span></td>
                                                    <td className="p-3 px-4 "><span className="float-start">Phone number</span>
                                                    </td>
                                                    <td className="p-3 px-4 "><span className="float-start">Method</span></td>
                                                    <td className="p-3 px-4 "><span className="float-start">Price</span></td>
                                                    <td className="p-3 px-4 "><span className="">Status</span></td>
                                                    <td className="p-3 px-4 "><span>Action</span></td>
                                                </tr>
                                                <tr className="table-content">
                                                    <td className="p-3 px-4 "><span className="float-start">200803</span></td>
                                                    <td className="p-3 px-4 "><span className="float-start">taile03</span></td>
                                                    <td className="p-3 px-4 "><span className="float-start">2024-1-2 13:23:44</span></td>
                                                    <td className="p-3 px-4 "><span className="float-start">Thu Duc</span></td>
                                                    <td className="p-3 px-4 "><span className="float-start">0903112345</span>
                                                    </td>
                                                    <td className="p-3 px-4 "><span className="float-start">VNPAY</span></td>
                                                    ...
                                                    <td className="p-3 px-4">
                                                        <div className="view-details d-flex justify-content-center" data-bs-toggle="modal" data-bs-target="#details-order">
                                                            <div className="edit-order p-2">
                                                                <i className="fa-solid fa-pen-to-square"></i>
                                                            </div>
                                                            <div className="edit-user-2 p-2 ps-1"><span>View Details</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
            ...
            <div className="modal-content">
                ...
                <div className="modal-body">
                    <table className="w-100 table-modal">
                        <tr>
                            <td className="p-2"><span>Order ID:</span></td>
                            <td className="p-2"><span>200803</span></td>
                            <td className="p-2"><span>Customer:</span></td>
                            <td className="p-2"><span>taile03</span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="3" className="p-2"><input type="text" name="" id="" className="w-100 ps-2"/></td>
                        </tr>
                        <tr>
                    ...
                    <div className="p-2">
                        <table className="w-100 text-center table-product-modal">
                            <tr className="product-modal-title">
                                <td><span className="py-2">Name</span></td>
                                <td><span className="py-2">Quantity</span></td>
                                <td className="w-25"><span className="float-start py-2">Price</span></td>
                            </tr>
                            <tr className="product-modal-list">
                                <td><span className="py-2">Wild</span></td>
                                <td><span className="py-2">5</span></td>
                                <td className="w-25"><span className="float-start py-2">750.000</span></td>
                            </tr>
                            <tr className="product-modal-list">
                                <td><span className="py-2">Stylish</span></td>
                                <td><span className="py-2">7</span></td>
                                <td className="w-25"><span className="float-start py-2">750.000</span></td>
                            </tr>
                            <tr className="product-modal-title">
                                <td><span className="py-2">Total</span></td>
                                <td><span className="py-2">12</span></td>
                                <td className="w-25"><span className="float-start py-2">1.500.500</span></td>
                            </tr>
                        </table>
                    </div>
                    <div className="p-2 mt-2">
                        ...
                        <tr>
                            <td className="py-2 w-20"><span>Status:</span></td>
                            <td className="py-2 w-80"><select name="" id="" className="ps-2">
                                <option value="">Cancelled</option>
                                <option value="">Pending</option>
                                <option value="">Completed</option>
                            </select></td>
                        ...
                        <tr>
                            <td className="py-2 w-20"><span>Note:</span></td>
                            <td className="py-2 w-80"><textarea id="myTextarea" name="myTextarea" rows="4" cols="50" className="w-75 p-2"></textarea></td>
                        </tr>
                    </table>
                    </div>
