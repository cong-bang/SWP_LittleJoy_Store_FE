        ...
        <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
                ...
                <div className="p-2" >
                    ...
                    <tbody>
                        <tr>
                        <td className="w-20"><span className="py-2" style={{color: '#3C75A6'}}>New Address:</span></td>
                        <td className="py-2">
                            <input
                            type="text"
                ...
                <div className="footer-modal py-4 d-flex justify-content-end" style={{backgroundColor: 'white'}}>
                    <div className="close me-4">
                        <div className="modal-btn-close p-2 px-4" data-bs-dismiss="modal" style={{backgroundColor: 'rgb(60, 117, 166)'}}><span>Close</span></div>
                    </div>
                    <div className="save-modal me-4">
                        <input onClick={handleAddAddress} type="submit" data-bs-dismiss="modal" value="Save" style={{backgroundColor: '#E33539'}} className="input-submit modal-btn-close p-2 px-4 inter"/>
                    </div>
                </div>
